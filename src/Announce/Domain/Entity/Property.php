...
use App\Announce\Domain\Entity\Traits\EntityLocationTrait;
use App\Announce\Domain\Entity\Traits\EntityTimestampableTrait;
...
#[ORM\Table(name: 'announce_property')]
class Property
{
    use CityTrait;
    use EntityIdTrait;
