...
trait BudgetTrait
{
    ...
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'budget', type: 'float')]
    ...
    #[Serializer\Expose]
    #[Serializer\Groups(['Activity_Entity', 'Project_Entity', 'Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'timeBudget', type: 'duration')]
    ...
    #[Serializer\Expose]
    #[Serializer\Groups(['Activity_Entity', 'Project_Entity', 'Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'budgetType')]
