...
#[\App\Crm\Application\Export\Annotation\Order(['id', 'createdAt', 'invoiceNumber', 'status', 'customer', 'subtotal', 'total', 'tax', 'currency', 'vat', 'dueDays', 'dueDate', 'paymentDate', 'user', 'invoiceFilename', 'customerNumber', 'comment'])]
#[\App\Crm\Application\Export\Annotation\Expose(name: 'customer', label: 'customer', exp: 'object.getCustomer() === null ? null : object.getCustomer().getName()')]
#[\App\Crm\Application\Export\Annotation\Expose(name: 'customerNumber', label: 'number', exp: 'object.getCustomer() === null ? null : object.getCustomer().getNumber()')]
#[\App\Crm\Application\Export\Annotation\Expose(name: 'dueDate', label: 'invoice.due_days', type: 'datetime', exp: 'object.getDueDate() === null ? null : object.getDueDate()')]
#[\App\Crm\Application\Export\Annotation\Expose(name: 'user', label: 'username', type: 'string', exp: 'object.getUser() === null ? null : object.getUser().getDisplayName()')]
#[\App\Crm\Application\Export\Annotation\Expose(name: 'paymentDate', label: 'invoice.payment_date', type: 'date', exp: 'object.getPaymentDate() === null ? null : object.getPaymentDate()')]
class Invoice implements EntityWithMetaFields
{
    ...
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'id', type: 'integer')]
    private ?int $id = null;
    #[ORM\Column(name: 'invoice_number', type: 'string', length: 50, nullable: false)]
    #[Assert\NotNull]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'invoice.number', type: 'string')]
    private ?string $invoiceNumber = null;
    #[ORM\Column(name: 'comment', type: 'text', nullable: true)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'comment')]
    ...
    #[Assert\NotNull]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'date', type: 'datetime')]
    private ?\DateTime $createdAt = null;
    #[ORM\Column(name: 'timezone', type: 'string', length: 64, nullable: false)]
    private ?string $timezone = null;
    #[ORM\Column(name: 'total', type: 'float', nullable: false)]
    #[Assert\NotNull]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'total_rate', type: 'float')]
    private float $total = 0.00;
    #[ORM\Column(name: 'tax', type: 'float', nullable: false)]
    #[Assert\NotNull]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'invoice.tax', type: 'float')]
    private float $tax = 0.00;
    #[ORM\Column(name: 'currency', type: 'string', length: 3, nullable: false)]
    #[Assert\NotNull]
    #[Assert\Length(max: 3)]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'currency', type: 'string')]
    private ?string $currency = null;
    #[ORM\Column(name: 'due_days', type: 'integer', length: 3, nullable: false)]
    #[Assert\NotNull]
    #[Assert\Range(min: 0, max: 999)]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'due_days', type: 'integer')]
    private int $dueDays = 30;
    #[ORM\Column(name: 'vat', type: 'float', nullable: false)]
    #[Assert\NotNull]
    #[Assert\Range(min: 0.0, max: 99.99)]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'tax_rate', type: 'float')]
    private float $vat = 0.00;
    #[ORM\Column(name: 'status', type: 'string', length: 20, nullable: false)]
    #[Assert\NotNull]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'status', type: 'string')]
    private string $status = self::STATUS_NEW;
    #[ORM\Column(name: 'invoice_filename', type: 'string', length: 150, nullable: false)]
    #[Assert\NotNull]
    #[Assert\Length(min: 1, max: 150)]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'file', type: 'string')]
    ...
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'invoice.subtotal', type: 'float', name: 'subtotal')]
