...
#[\App\Crm\Application\Export\Annotation\Order(['id', 'name', 'company', 'number', 'vatId', 'address', 'contact', 'email', 'phone', 'mobile', 'fax', 'homepage', 'country', 'currency', 'timezone', 'budget', 'timeBudget', 'budgetType', 'color', 'visible', 'teams', 'comment', 'billable'])]
...
class Customer implements EntityWithMetaFields, EntityWithBudget
{
    ...
    #[Serializer\Expose]
    #[Serializer\Groups(['Default'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'name')]
    private ?string $name = null;
    #[ORM\Column(name: 'number', type: 'string', length: 50, nullable: true)]
    #[Assert\Length(max: 50)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Default'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'number')]
    ...
    #[Serializer\Expose]
    #[Serializer\Groups(['Default'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'visible', type: 'boolean')]
    private bool $visible = true;
    #[ORM\Column(name: 'billable', type: 'boolean', nullable: false, options: ['default' => true])]
    #[Assert\NotNull]
    #[Serializer\Expose]
    #[Serializer\Groups(['Default'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'billable', type: 'boolean')]
    private bool $billable = true;
    #[ORM\Column(name: 'company', type: 'string', length: 100, nullable: true)]
    #[Assert\Length(max: 100)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'company')]
    private ?string $company = null;
    #[ORM\Column(name: 'vat_id', type: 'string', length: 50, nullable: true)]
    #[Assert\Length(max: 50)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'vat_id')]
    private ?string $vatId = null;
    #[ORM\Column(name: 'contact', type: 'string', length: 100, nullable: true)]
    #[Assert\Length(max: 100)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'contact')]
    private ?string $contact = null;
    #[ORM\Column(name: 'address', type: 'text', nullable: true)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'address')]
    ...
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'country')]
    ...
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'currency')]
    private ?string $currency = self::DEFAULT_CURRENCY;
    #[ORM\Column(name: 'phone', type: 'string', length: 30, nullable: true)]
    #[Assert\Length(max: 30)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'phone')]
    private ?string $phone = null;
    #[ORM\Column(name: 'fax', type: 'string', length: 30, nullable: true)]
    #[Assert\Length(max: 30)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'fax')]
    private ?string $fax = null;
    #[ORM\Column(name: 'mobile', type: 'string', length: 30, nullable: true)]
    #[Assert\Length(max: 30)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'mobile')]
    ...
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'email')]
    private ?string $email = null;
    #[ORM\Column(name: 'homepage', type: 'string', length: 100, nullable: true)]
    #[Assert\Length(max: 100)]
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'homepage')]
    ...
    #[Serializer\Expose]
    #[Serializer\Groups(['Customer_Entity'])]
    #[\App\Crm\Application\Export\Annotation\Expose(label: 'timezone')]
