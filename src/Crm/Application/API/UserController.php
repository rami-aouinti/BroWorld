...
final class UserController extends BaseApiController
{
    ...
    #[Rest\QueryParam(name: 'visible', requirements: '1|2|3', default: 1, description: 'Visibility status to filter users: 1=visible, 2=hidden, 3=all', strict: true, nullable: true)]
    #[Rest\QueryParam(name: 'orderBy', requirements: 'id|username|alias|email', description: 'The field by which results will be ordered. Allowed values: id, username, alias, email (default: username)', strict: true, nullable: true)]
    #[Rest\QueryParam(name: 'order', requirements: 'ASC|DESC', description: 'The result order. Allowed values: ASC, DESC (default: ASC)', strict: true, nullable: true)]
    ...
    #[OA\Parameter(name: 'id', description: 'User ID to fetch', in: 'path', required: true)]
    ...
    #[OA\Parameter(name: 'id', description: 'User ID to update', in: 'path', required: true)]
