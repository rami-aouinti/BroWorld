...
final class DashboardController extends AbstractController
{
    ...
    #[Route(path: '/', name: 'dashboard', options: ['sitemap' => true], defaults: [], methods: ['GET'])]
    ...
    #[Route(path: '/reset/', name: 'dashboard_reset', options: ['sitemap' => true], defaults: [], methods: ['GET', 'POST'])]
