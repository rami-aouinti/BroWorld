...
final class WizardController extends AbstractController
{
    ...
    public function wizard(Request $request, UserService $userService, string $wizard): Response
    {
        ...
        if ($wizard === 'intro') {
            ...
            return $this->render('frontend/wizard/intro.html.twig', [
                'percent' => 0,
                'next' => 'profile',
            ]);
        }
        ...
        if ($wizard === 'profile') {
            ...
            return $this->render('frontend/wizard/profile.html.twig', [
        ...
        if ($wizard === 'done') {
            return $this->render('frontend/wizard/done.html.twig', [
                'percent' => 100,
                'previous' => 'profile',
            ]);
        }
